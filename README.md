...
- **v0.8.3.2 DEV** — complementação de abastecimentos (tipo, litros e posto), correspondência segura por data + valor e gerenciador sincronizado de postos.
...
3. **Crie o projeto no Supabase** (supabase.com, plano Free) e depois:
   ...
   - Para a v0.8.3.2 DEV, rode também `supabase/migrations/007_postos_gerenciados.sql`
